...
class ContainerTask(MPILoggedTask, extensions.BasicContMixin):
    ...
    def __init__(self) -> None: ...
    def next(
        self, *input: Iterable[BasicCont]
    ) -> tuple[BasicCont, ...] | BasicCont | None: ...
    def finish(self) -> tuple[BasicCont, ...] | BasicCont | None: ...
    def _process_output(self, output: BasicCont, ii: int = 0) -> BasicCont: ...
    def _save_output(self, output: BasicCont, ii: int = 0) -> str | None: ...
    def _nan_process_output(self, output: BasicCont) -> BasicCont | None: ...
    def _interpolation_dict(self, output: BasicCont, ii: int = 0) -> dict[str, Any]: ...
    def _nan_check_walk(self, cont: BasicCont) -> bool: ...
