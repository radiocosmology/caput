...
large computation to disk in an intelligent manner (not yet implemented). These
subclasses are implemented in the private :mod:`_extensions` submodule.
...
# primary namespace should include:
# Manager, task, containers
# Things from pybridge and extensions could be in `lib`
from . import _core
from ._core import *
from . import (
...
__all__ = [*_core.__all__, "containers", "lib", "task"]
