...
class BasicCont(MemDiskGroup):
    ...
    @property
    def history(self) -> ro_dict: ...
    @property
    def index_map(self) -> ro_dict: ...
    @property
    def index_attrs(self) -> ro_dict: ...
    @property
    def reverse_map(self) -> ro_dict: ...
    def group_name_allowed(self, name: str) -> Literal[False]: ...
    def dataset_name_allowed(self, name: str) -> bool: ...
    def create_index_map(
        self, axis_name: str, index_map: npt.ArrayLike[Any]
    ) -> None: ...
