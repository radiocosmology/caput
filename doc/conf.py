...
project = u'caput'
copyright = u'2013-2016, Kiyoshi Masui and J. Richard Shaw'
...
latex_documents = [
  ('index', 'caput.tex', u'caput Documentation',
...
man_pages = [
    ('index', 'caput', u'caput Documentation',
     [u'Kiyoshi Masui'], 1)
]
...
texinfo_documents = [
  ('index', 'caput', u'caput Documentation',
   u'Kiyoshi Masui', 'caput', 'Cluster Astronomical Python Utilities',
   'Miscellaneous'),
]
